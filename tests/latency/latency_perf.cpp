...
static struct latency_parameters tests_15fps[] = {
    // All Color modes with fast Depth
    {  0, "FPS_15_MJPEG_3072P_PASSIVE_IR",     K4A_FRAMES_PER_SECOND_5, K4A_IMAGE_FORMAT_COLOR_MJPG,   K4A_COLOR_RESOLUTION_3072P, K4A_DEPTH_MODE_PASSIVE_IR},
    {  1, "FPS_15_BGRA32_3072P_PASSIVE_IR",    K4A_FRAMES_PER_SECOND_5, K4A_IMAGE_FORMAT_COLOR_BGRA32, K4A_COLOR_RESOLUTION_3072P, K4A_DEPTH_MODE_PASSIVE_IR},

    // All Depth Modes with fastest Color
    {  2, "FPS_15_YUY2__0720P_WFOV_UNBINNED",  K4A_FRAMES_PER_SECOND_5, K4A_IMAGE_FORMAT_COLOR_YUY2,   K4A_COLOR_RESOLUTION_720P,  K4A_DEPTH_MODE_WFOV_UNBINNED},
};
